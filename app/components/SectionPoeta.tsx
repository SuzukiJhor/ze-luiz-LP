...
export default function SectionPoeta() {
    ...
    return (
        <section className="relative py-40 px-6 overflow-hidden">
            ...
            <div className="relative z-20 max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
                ...
                >
                    ...
                    <h3 className="text-5xl md:text-6xl font-bold font-display mb-10 leading-tight">
                    ...
                    <div className="space-y-6 text-lg text-white/70 leading-relaxed">
                        ...
                        <p>
                            Enraizado em Monteiro – PB, Zé Luiz do Candeeiro nasceu
                            em Tupanatinga, entre o agreste e sertão pernambucano,
                            em 19 de maio de 1981.
                        </p>

                        <p>
                            Filho de Seu José Cavalcanti de Albuquerque e de Dona
                            Izita dos Santos, carrega na própria história a marca
                            de uma origem humilde profundamente ligada à caatinga,
                            à cultura popular e às manifestações do seu povo.
                        </p>

                        <p>
                            Descendente dos negros do carrasco e trazendo no sangue
                            a tradição da Mestra Mariquinha do Samba de Coco,
                            constrói uma obra em que poesia, música e memória
                            caminham juntas.
                        </p>

                        <p>
                            Poeta, cantor e compositor, é Doutor em Ensino de Ciências
                            e Matemática e atua na formação de professores na
