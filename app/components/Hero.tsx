    ...
    >
      ...
      >
        <Image
          ...
          fill
          className='object-contain opacity-30 md:opacity-35 scale-110 md:scale-125 mix-blend-screen'
        />
      </motion.div>
      ...
      <div className='absolute inset-0 flex items-center justify-center pointer-events-none'>
        <div className='w-80 h-80 md:w-125 md:h-125 bg-primary/10 blur-[120px] rounded-full' />
      </div>
      ...
      <div className='max-w-7xl mx-auto px-6 text-center relative z-20 flex flex-col items-center justify-center min-h-[80vh]'>
        ...
        >
          ...
          <h1 className='text-4xl md:text-6xl lg:text-7xl font-semibold font-display mb-8 leading-[1.1] tracking-tight'>
            <span className='block text-white/90 transition-colors duration-500'>
              Zé Luiz do
            </span>

            <span className='block bg-linear-to-r 0 bg-clip-text text-transparent from-white via-white to-white/60'>
              Candeeiro
            </span>
          </h1>

          <p className='text-lg md:text-xl text-white/70 max-w-2xl mx-auto mb-12 leading-relaxed font-body'>
          ...
          <div className='flex flex-col sm:flex-row gap-6 justify-center'>
            ...
            <Link
              href='/poesia'
              className='px-8 py-4 rounded-full bg-primary text-primary-foreground flex items-center gap-3 shadow-lg shadow-primary/20 hover:scale-105 transition-all'
            >
